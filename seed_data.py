...
with app.app_context():
    ...
    ingredients = [
        # vegetable
        Ingredient(name="Spinach",        type="vegetable", is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        Ingredient(name="Broccoli",       type="vegetable", is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        Ingredient(name="Sweet Potato",   type="vegetable", is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        Ingredient(name="Kale",           type="vegetable", is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        Ingredient(name="Garlic",         type="vegetable", is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        Ingredient(name="Beetroot",       type="vegetable", is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        # legume
        Ingredient(name="Lentils",        type="legume",    is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=True),
        Ingredient(name="Chickpeas",      type="legume",    is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=True),
        # fish
        Ingredient(name="Salmon",         type="fish",      is_vegan=False, is_vegetarian=False, is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=True),
        Ingredient(name="Sardines",       type="fish",      is_vegan=False, is_vegetarian=False, is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=True),
        # nut
        Ingredient(name="Almonds",        type="nut",       is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=False, is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=True),
        Ingredient(name="Walnuts",        type="nut",       is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=False, is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=True),
        # fruit — avocado exception: low_sugar=True
        Ingredient(name="Avocado",        type="fruit",     is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        Ingredient(name="Blueberries",    type="fruit",     is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=False, is_high_protein=False, is_mediterranean=True),
        # dairy
        Ingredient(name="Greek Yogurt",   type="dairy",     is_vegan=False, is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=False, is_nut_free=True,  is_egg_free=True,  is_low_sugar=False, is_high_protein=True,  is_mediterranean=True),
        Ingredient(name="Kefir",          type="dairy",     is_vegan=False, is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=False, is_nut_free=True,  is_egg_free=True,  is_low_sugar=False, is_high_protein=True,  is_mediterranean=True),
        # grain — quinoa exception: gluten_free=True
        Ingredient(name="Oats",           type="grain",     is_vegan=True,  is_vegetarian=True,  is_gluten_free=False, is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=False, is_high_protein=False, is_mediterranean=True),
        Ingredient(name="Quinoa",         type="grain",     is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=False, is_high_protein=False, is_mediterranean=True),
        # protein — eggs exception: egg_free=False, mediterranean=False
        Ingredient(name="Eggs",           type="protein",   is_vegan=False, is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=False, is_low_sugar=True,  is_high_protein=True,  is_mediterranean=False),
        # spice
        Ingredient(name="Turmeric",       type="spice",     is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        Ingredient(name="Ginger",         type="spice",     is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        # seed
        Ingredient(name="Pumpkin Seeds",  type="seed",      is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=True),
        # other — dark chocolate: may contain gluten/dairy/nuts, has sugar
        Ingredient(name="Dark Chocolate", type="other",     is_vegan=True,  is_vegetarian=True,  is_gluten_free=False, is_dairy_free=False, is_nut_free=False, is_egg_free=True,  is_low_sugar=False, is_high_protein=False, is_mediterranean=True),
        # oil
        Ingredient(name="Olive Oil",      type="oil",       is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        # herb
        Ingredient(name="Chamomile",      type="herb",      is_vegan=True,  is_vegetarian=True,  is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=False, is_mediterranean=True),
        # meat — lamb exception: mediterranean=True
        Ingredient(name="Chicken Breast", type="meat",      is_vegan=False, is_vegetarian=False, is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=False),
        Ingredient(name="Beef Steak",     type="meat",      is_vegan=False, is_vegetarian=False, is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=False),
        Ingredient(name="Turkey",         type="meat",      is_vegan=False, is_vegetarian=False, is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=False),
        Ingredient(name="Lamb",           type="meat",      is_vegan=False, is_vegetarian=False, is_gluten_free=True,  is_dairy_free=True,  is_nut_free=True,  is_egg_free=True,  is_low_sugar=True,  is_high_protein=True,  is_mediterranean=True),
    ]
